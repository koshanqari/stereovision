...
from rs_device_manager.realsense_device_manager_S_L import DeviceManager
...
rospy.init_node('talker_side_left', anonymous=True)

pub = rospy.Publisher('/camera_side_left', numpy_msg(Floats), queue_size=10)
#scale = 0.04/np.absolute(OBJ_TR[0]-OBJ_TL[0])
